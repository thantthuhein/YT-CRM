...
use App\Http\Resources\Admin\EnquiriesTypeResource;
use Gate;
use Illuminate\Http\Request;
use Symfony\Component\HttpFoundation\Response;

class EnquiriesTypeApiController extends Controller
{
    public function index()
    {
        abort_if(Gate::denies('enquiries_type_access'), Response::HTTP_FORBIDDEN, '403 Forbidden');

        return new EnquiriesTypeResource(EnquiriesType::all());
    }
    ...
    public function store(StoreEnquiriesTypeRequest $request)
    {
        ...
        return (new EnquiriesTypeResource($enquiriesType))
            ->response()
