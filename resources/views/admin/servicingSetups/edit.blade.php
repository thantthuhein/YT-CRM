...
<div class="card content-card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.servicingSetup.title_singular') }}
    </div>
    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route("admin.servicing-setups.update", [$servicingSetup->id]) }}" enctype="multipart/form-data">
            ...
            @if ($servicingSetup->service_report_pdf)
                <div class="form-group">
                    <p class="font-weight-bold">Uploaded Service Report PDF</p>
                    <div class="d-flex">
            ...
            @endif
            <div class="form-group">
                <label for="service_report_pdf">Upload Service Report PDF</label>
            ...
            {{-- <h1>{{ $servicingSetup->servicingTeamConnectors }}</h1> --}}
