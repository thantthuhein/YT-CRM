                        ...
                        <tr data-entry-id="{{ $inHouseInstallation->id }}">
                            ...
                            <td>
                                ...
                                <div class="progress" style="height: 10px; margin-bottom: 10px">
                                    <div class="progress-bar" role="progressbar" style="color: black;width: {{ $inHouseInstallation->progress }}%;" value={{ $inHouseInstallation->progress }} aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
