    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.reminders.update", [$reminder->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('remindable') ? 'is-invalid' : '' }}" type="number" name="remindable" id="remindable" value="{{ old('remindable', $reminder->remindable) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reminable_type') ? 'is-invalid' : '' }}" type="text" name="reminable_type" id="reminable_type" value="{{ old('reminable_type', $reminder->reminable_type) }}">
