...
<head>
    ...
    <link rel="shortcut icon" href="https://res.cloudinary.com/dcs3zcs3v/image/upload/v1575530876/logo-favicon.ico" type="image/x-icon"/>
    <link href="{{ asset('css/custom.css') }}" rel="stylesheet" />
    <lint href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.11.2/webfonts/fa-regular-400.woff"/>
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.11.2/js/regular.min.js"/>
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.11.2/css/all.css"/>
    <link href='http://fonts.googleapis.com/css?family=Oxygen:400,300' rel='stylesheet' type='text/css'>
    <link href="https://fonts.googleapis.com/css?family=Montserrat&display=swap" rel="stylesheet">
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    <link href="{{ asset('css/auth/enquiry.css') }}" rel="stylesheet" />
    <link href="{{ asset('css/auth/dashboard.css') }}" rel="stylesheet" />

    @yield('styles')
</head>

<body class="sidebar-mini layout-fixed" style="height: auto; background: #03223D;">
    <div class="wrapper">
...
<body class="sidebar-mini layout-fixed main-font" style="height: auto;">
    <div id="app" class="wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="content-wrapper">
                        <nav-component query="{{ request()->q ?? "" }}" search-route={{ route('admin.enquiries.index') }} current-username={{ Auth::check() ? auth()->user()->name : "--" }}></nav-component>
                        <!-- Breadcramp -->
                        ...
                        @if(Auth::check() && (auth()->user()->reminderJobsList()->count() || auth()->user()->remainingJobs->count() > 0))
                            <div class="alert alert-danger" style="margin-left:30px;margin-right:30px;">
                                You have remaining jobs to do or to remind. Check out jobs <a href="{{ route("admin.remaining-jobs.index") }}"> here ....</a>
                            </div>
                        @endif
        ...
        <footer class="main-footer" style="padding-left:30px;padding-right:30px;">
            <div class="float-right text-white d-none d-sm-block">
                <b>Version</b> 0.0.6-alpha
            </div>
            <strong class="text-white">Copyright 2019 &copy; Ywar Taw</strong>
        </footer>
